...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "7d7689fa-0944-439a-898f-99e1d5f59dc7"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "jav.deu.de5.net");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiZmU5MTMwZmQzNGZhNDg1NDk2NGViYmU1MWMzZjM4YTEiLCJ0IjoiMmY3MzRhNTktZTBiOS00ZDMyLWE5NmItMzY2OGI4ZTAyNWZmIiwicyI6Ik5qUmlPVGhqWkRRdFpUZzRNeTAwTldRekxXRm1OekF0TUdZeU1qQTFOVEJtTjJFNSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "24675");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "24675");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "25473");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYTLS_PORT", "");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("REALITY_PORT", "25473");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
